...
with open('tps_report.csv', 'a', newline='') as csvfile:
    ...
    for worker in employees:
        worker['finished_review'] = "yes"

        if worker['first_name'] == "Bill" or worker['job_title'] == "Consultant":
            worker['performance_review'] = "poor"
        else:
            worker['performance_review'] = "excellent"
